<?php
    ...
    if($viewer){
        ...
        echo '
        <div class="grow-wrap">
            <textarea name="content" id="content1'.$id.'" class="normal" onInput="this.parentNode.dataset.replicatedValue = this.value" style="font-size: 40px; height: 40px; box-sizing: content-box;" placeholder="Lorem Ipsum Dolor" disabled>'.$data[0].'</textarea>
        </div>
        ';
        if(!$preview){
