function getcaldata(username, password) {
    var ajax = $.post("/admin/api/calendar.php", { "action": "geteventlist", "username": username, "password_hash": password }, function (data) { console.log(ajax.status); processcaldata(JSON.parse(data)["data"]); });
}
