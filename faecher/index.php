            ...
            <section class="faecher">
                <div class="bereichdiv">
                    ...
                    <ul class="faecherlist">
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Deutsch.svg" class="fachimg"><br><span>Deutsch</span></div></li></a> <!-- https://freesvg.org/stack-of-books-vector-clip-art -->
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Englisch.svg" class="fachimg"><br><span>Englisch</span></div></li></a> <!-- https://en.wikipedia.org/wiki/File:English_language.svg -->
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Französisch.svg" class="fachimg"><br><span>Französisch</span></div></li></a> <!-- https://commons.wikimedia.org/wiki/File:France_flag_waving_icon.svg -->
                        <!-- <a><li class="fach"><div><img src="" class="fachimg"><br><span>Polnisch</span></div></li></a> -->
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Russisch.svg" class="fachimg"><br><span>Russisch</span></div></li></a> <!-- https://freesvg.org/flag-of-the-russian-federation-vector-graphics -->
                        ...
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Latein.svg" class="fachimg"><br><span>Latein</span></div></li></a> <!-- https://svgsilh.com/image/161704.html -->
                    </ul>
                </div>
                <div class="bereichdiv">
                ...
                <div class="bereichdiv">
                    ...
                    <ul class="faecherlist">
                        ...
                        <a><li class="fach"><div><picture><source srcset="/files/site-ressources/faecher-icons/Gesellschaftswissenschaften-Dark.svg" media="(prefers-color-scheme: dark)"><img src="/files/site-ressources/faecher-icons/Gesellschaftswissenschaften.svg" class="fachimg"></picture><br><span>Gesellschaftswissenschaften</span></div></li></a> <!-- https://publicdomainvectors.org/en/vectoriales-gratuitas/Diosa-de-la-justicia-signo-vector-de-la-imagen/16404.html -->
                        <a><li class="fach"><div><picture><source srcset="/files/site-ressources/faecher-icons/RE-Dark.svg" media="(prefers-color-scheme: dark)"><img src="/files/site-ressources/faecher-icons/RE.svg" class="fachimg"></picture><br><span>Religion</span></div></li></a> <!-- https://commons.wikimedia.org/wiki/File:Religion_icon.svg -->
                        ...
                        <a><li class="fach"><div><picture><source srcset="/files/site-ressources/faecher-icons/LER-Dark.svg" media="(prefers-color-scheme: dark)"><img src="/files/site-ressources/faecher-icons/LER.svg" class="fachimg"></picture><br><span>Lebensgestaltung-Ethik-Religionskunde</span></div></li></a> <!-- https://unterrichten.zum.de/index.php?title=Datei:Buch-Icon.svg&veaction=edit&redlink=1 -->
                        <a><li class="fach"><div><picture><source srcset="/files/site-ressources/faecher-icons/WAT-Dark.svg" media="(prefers-color-scheme: dark)"><img src="/files/site-ressources/faecher-icons/WAT.svg" class="fachimg"></picture><br><span>Wirtschaft-Arbeit-Technik<br>Wirtschaftswissenschaften</span></div></li></a> <!-- https://commons.wikimedia.org/wiki/File:Euro_sign.svg -->
                ...
                <div class="bereichdiv">
                    ...
                    <ul class="faecherlist">
                        <a><li class="fach"><div><img src="/files/site-ressources/faecher-icons/Sport.svg" class="fachimg"><br><span>Sport</span></div></li></a> <!-- https://svgsilh.com/image/309539.html -->
                    </ul>
                </div>
            </section>
